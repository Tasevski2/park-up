        ...
        <table>
          ...
          <tbody>
            <tr className='add-row'>
              ...
              <td className='add-td'>
                <TableDataInput
                  value={newParkingSpace.parkingSpaceNumber}
                  onChange={(e) =>
                    setNewParkingSpace({
                      ...newParkingSpace,
                      parkingSpaceNumber: e.target.value,
                    })
                  }
                />
              </td>
              <td>
                <IconButton
                  style={{ padding: 3.5 }}
                  onClick={() => handleParkingSpacesChange({ type: 'add' })}
                >
                  <AddIcon />
                </IconButton>
              </td>
            </tr>
            {parkingSpaces.map(({ lat, lng, parkingSpaceNumber }, index) => (
              <tr key={index}>
                <td>
                  <IconButton
                    style={{ padding: 3.5 }}
